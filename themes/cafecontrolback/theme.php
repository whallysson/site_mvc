...
<head>
    <meta charset="UTF-8">
    <meta name="mit" content="2020-05-03T03:36:39-03:00+173226">
    <meta name="viewport" content="width=device-width,initial-scale=1">

    <title>AmorimWS - Seu Sistema de vendas completo</title>

    <link rel="icon" type="image/png" href="<?= theme( "/assets/images/favicon.png"); ?>"/>

    <link rel="stylesheet" href="<?php echo theme("/assets/style.css"); ?>"/>
...
<header class="main_header gradient gradient-green">
    <div class="container">
        <div class="main_header_logo">
            <h1><a class="icon-coffee transition" title="Home" href="<?php url(); ?>">AmorimWS<b>Sistema</b></a></h1>
        </div>
        ...
        <nav class="main_header_nav">
            ...
            <div class="main_header_nav_links j_menu_mobile_tab">
                ...
                <a class="link transition radius active" title="Home" href="<?php url(); ?>">Home</a>
                <a class="link transition radius" title="Sobre" href="<?php url("sobre"); ?>">Sobre</a>
                <a class="link transition radius" title="Blog" href="<?php url("blog"); ?>">Blog</a>
                <a class="link login transition radius icon-sign-in" title="Entrar" href="<?php url("entrar"); ?>">Entrar</a>
            </div>
        </nav>
    </div>
</header>
    ...
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item social">
                ...
                <a target="_blank" class="icon-facebook" href="https://facebook.com/<?php CONF_SOCIAL_FACEBOOK_PAGE; ?>" title="CafeControl no Facebook">           CafeControl
                </a>

                <a target="_blank" class="icon-instagram" href="https://instagram.com/<?php CONF_SOCIAL_INSTAGRAM_PAGE; ?>" title="CafeControl no Instagram">
                    @CafeControl
                </a>
...
<script src="<?php theme( "/assets/scripts.js"); ?>"></script>
