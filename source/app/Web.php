...
class Web extends Controller 
{
    ...
    public function blog(?array $data) : void
    {
        ...
        $head = $this->seo->render(
            "Blog" . CONF_SITE_NAME,
            "Descrião blog , sobre o que ele fala etc",
            url("/blog"),
            theme("/assets/images/share.jpg")
        );
    ...
    public function login(?array $data): void
    {
        ...
        if(!empty($data['csrf'])) {
            ...
            if(request_limit("weblogintest2", 3, "500")) {
                $json['message'] = $this->message->error("Você já efetuou 3 tentativas, é o limite, por favor aguarda por 5 min para tentar novamente")->render();
                echo json_encode($json);
                return;
            }
    ...
    public function success(array $data): void
    {
        ...
        echo $this->view->render("optin", [
            ...
            "track" => (object)[
                "fb" => "Lead",
                "aw" => "AW-650000484/VfJyCPucpNEBEOTw-LUC"
            ]
        ]);
    }
    ...
    public function error(array $data): void
    {
        ...
        switch ($data['errcode']) {
            case "problemas":
                ...
                $error->message = "Parece que nosso serviço não está dispinível momento. Já estamos vendo isso mas caso preciso entre em precise, envie um e-mail :/";
            ...
            default:
                ...
                $error->message = "Sentimos muito, mas o conteúdo que você tentou acessar não existe, está indisponível nomemento ou foi removido :/";
